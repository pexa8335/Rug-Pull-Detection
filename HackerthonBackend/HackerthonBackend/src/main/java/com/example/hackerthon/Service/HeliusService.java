...
import com.example.hackerthon.Dto.Response.ResponseField;
import com.example.hackerthon.Dto.Response.RugPullResponse;
import com.example.hackerthon.Mapper.HeliusMapper;
...
public class HeliusService {
    ...
    private final HeliusMapper heliusMapper;
    ...
    public ResponseField getPredict(String address) {
        try {
            PredictResponse predictResponse = extractPoolFeatures(address);
            RugPullResponse rugPullResponse = aiModelClient.predict(predictResponse);
            HeliusResponse helius= heliusMapper.toHeliusResponse(predictResponse);
            return ResponseField.builder()
                    .helius(helius)
                    .AiModule(rugPullResponse)
                    .build();
        } catch (Exception e) {
